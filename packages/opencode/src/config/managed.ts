...
const MANAGED_PLIST_DOMAIN = "ai.pixi.managed"
...
function systemManagedConfigDir(): string {
  switch (process.platform) {
    ...
    case "win32":
      return path.join(process.env.ProgramData || "C:\\ProgramData", "pixi")
    default:
      return "/etc/opencode"
  }
}
...
export function managedConfigDir() {
  return process.env.PIXI_TEST_MANAGED_CONFIG_DIR || systemManagedConfigDir()
}
